...
$sqlUserid ="SELECT user_id FROM users WHERE validation_code='$codeToVerify'";
$connect->query($sqlUserid);

$result=$connect->query($sqlUserid);
...
<html>
  ...
  <!-- bootstrap js -->
    ...
    <body>
        <h3 style="margin-left:10px;">Email confirmed. Redirecting you ...</h3>
    </body>
</html>';
