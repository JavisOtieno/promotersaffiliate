...
$(document).ready(function() {
	...
	if(divRequest == 'add')  {
		...
		$("#createOrderForm").unbind('submit').bind('submit', function() {
			...
			var clientDeliveryDetails=$("#clientDeliveryDetails").val();
			...
			if(clientEmail == "") {
				$("#clientEmail").after('<p class="text-danger"> The Client Email Field is required </p>');
				$('#clientEmail').closest('.form-group').addClass('has-error');
			} else {
				$('#clientEmail').closest('.form-group').addClass('has-success');
			} // /else

			if(clientDeliveryDetails == "") {
				$("#clientDeliveryDetails").after('<p class="text-danger"> The Client Delivery Details Field is required </p>');
				$('#clientDeliveryDetails').closest('.form-group').addClass('has-error');
			} else {
				$('#clientDeliveryDetails').closest('.form-group').addClass('has-success');
			} // /else   		   	
	   	     	

	   	    if(productName == "") {
				$("#productName").after('<p class="text-danger"> The Product Name is required </p>');
			...
			if(clientName && clientContact && clientEmail && clientDeliveryDetails && productName) {
		...
		$("#editOrderForm").unbind('submit').bind('submit', function() {
			...
			if(clientEmail == "") {
				$("#clientEmail").after('<p class="text-danger"> The Client Name field is required </p>');
				$('#clientEmail').closest('.form-group').addClass('has-error');
			} else {
				$('#clientEmail').closest('.form-group').addClass('has-success');
			} // /else
			...
			if(clientDeliveryDetails == "") {
				$("#clientDeliveryDetails").after('<p class="text-danger"> The Client delivery details is required </p>');
				$('#clientDeliveryDetails').closest('.form-group').addClass('has-error');
			} else {
				$('#clientDeliveryDetails').closest('.form-group').addClass('has-success');
			} // /else
